...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      viewer_api_key_revoke: {
        Args: { p_api_key_id: number }
        Returns: undefined
      }
      ...
      viewer_organization_membership_invitation_cancel: {
        Args: { organization_membership_id: number }
        Returns: {
          organization_id: number
          organization_membership_accepted_at: string | null
      ...
      viewer_organization_membership_permission_grant: {
        Args: { organization_membership_id: number; permission_id: string }
        Returns: undefined
      }
      viewer_organization_membership_permission_revoke: {
        Args: { organization_membership_id: number; permission_id: string }
        Returns: undefined
      }
      ...
      viewer_organization_membership_revoke: {
        Args: { organization_membership_id: number }
        Returns: {
          organization_id: number
          organization_membership_accepted_at: string | null
