...
export type Database = {
  public: {
    ...
    Functions: {
      agency_has_other_active_admin: {
        Args: { _agency_id: number; _excluded_agency_membership_id: number }
        Returns: boolean
      }
      agency_id_of_membership: {
      ...
      viewer_agency_membership_invite_by_email: {
        Args: { agency_id: number; email: string }
        Returns: {
          agency_id: number
          agency_membership_accepted_at: string | null
          agency_membership_created_at: string
      ...
      viewer_agency_membership_respond: {
      ...
      viewer_agency_membership_update: {
        Args: { agency_membership_id: number; operation: string }
        Returns: {
          agency_id: number
          agency_membership_accepted_at: string | null
          agency_membership_created_at: string
      ...
      viewer_agency_team_permission_ids: {
        Args: { permission_id: string }
        Returns: number[]
      }
      ...
      viewer_has_agency_team_permission: {
        Args: { agency_id: number; permission_id: string }
        Returns: boolean
      }
