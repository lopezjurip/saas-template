...
export type Database = {
  public: {
    Tables: {
      ...
      affiliations: {
        Row: {
          affiliation_accepted_at: string | null
          affiliation_created_at: string
          affiliation_id: number
          affiliation_rejected_at: string | null
          affiliation_revoked_at: string | null
          affiliation_updated_at: string
          agency_id: string
          profile_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "affiliations_agency_id_fkey"
            columns: ["agency_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "affiliations_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
      ...
      agencies_organizations_implicit_grants: {
        Row: {
          agencies_organizations_implicit_grant_created_at: string
          agencies_organizations_implicit_grant_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "agencies_organizations_implicit_grants_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["organization_id"]
          ...
          {
            foreignKeyName: "agencies_organizations_implicit_grants_permission_id_fkey"
            columns: ["permission_id"]
            isOneToOne: false
            referencedRelation: "permissions"
            referencedColumns: ["permission_id"]
