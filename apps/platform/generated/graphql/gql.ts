...
const documents: Documents = {
    ...
    "\n  query AgencyOverviewPageQuery($agencyId: Int!) {\n    activeMemberships: viewerAgencyMemberships(\n      agencyId: $agencyId\n      filter: {\n        agencyMembershipAcceptedAt: { is: NOT_NULL }\n        agencyMembershipRevokedAt: { is: NULL }\n        agencyMembershipRejectedAt: { is: NULL }\n      }\n    ) {\n      totalCount\n    }\n    pendingMemberships: viewerAgencyMemberships(\n      agencyId: $agencyId\n      filter: {\n        agencyMembershipAcceptedAt: { is: NULL }\n        agencyMembershipRevokedAt: { is: NULL }\n        agencyMembershipRejectedAt: { is: NULL }\n      }\n    ) {\n      totalCount\n    }\n    grants: permissionGrantsCollection(\n      filter: { subjectAgencyId: { eq: $agencyId } }\n      first: 250\n    ) {\n      edges {\n        node {\n          objectOrganizationId\n          permissionId\n        }\n      }\n    }\n  }\n": types.AgencyOverviewPageQueryDocument,
    ...
    "\n  mutation ExternalAccessGrantMutation($organization_id: Int!, $agency_id: Int!) {\n    grant: viewerGrantAgencyAccess(organizationId: $organization_id, agencyId: $agency_id) {\n      permissionGrantId\n    }\n  }\n": types.ExternalAccessGrantMutationDocument,
    "\n  mutation ExternalAccessRevokeMutation($organization_id: Int!, $agency_id: Int!) {\n    revoke: viewerRevokeAgencyAccess(organizationId: $organization_id, agencyId: $agency_id) {\n      permissionGrantId\n    }\n  }\n": types.ExternalAccessRevokeMutationDocument,
    ...
    "\n  fragment EditPermissionsFormPermissionFragment on Permissions {\n    permissionId\n    permissionDescription\n  }\n": types.EditPermissionsFormPermissionFragmentFragmentDoc,
    "\n  fragment EditPermissionsFormPresetFragment on PermissionPresets {\n    permissionPresetId\n    permissionPresetName\n    permissionPresetSlugs\n    organizationId\n  }\n": types.EditPermissionsFormPresetFragmentFragmentDoc,
    ...
    "\n  query CheckTenantPermission($tenantId: Int!, $permissionId: String!) {\n    viewerHasTenantPermission(tenantId: $tenantId, permissionId: $permissionId)\n  }\n": types.CheckTenantPermissionDocument,
    "\n  mutation InsertSsoProvider($tenantId: Int!, $ssoProviderId: String!, $label: String!, $domains: [String]!, $enabled: Boolean!) {\n    insertIntoTenantSsoProvidersCollection(objects: [{\n      tenantId: $tenantId\n      ssoProviderId: $ssoProviderId\n      ssoProviderLabel: $label\n      ssoProviderDomains: $domains\n      ssoProviderEnabled: $enabled\n    }]) {\n      affectedCount\n    }\n  }\n": types.InsertSsoProviderDocument,
    "\n  mutation DeleteSsoProvider($tenantId: Int!, $ssoProviderId: String!) {\n    deleteFromTenantSsoProvidersCollection(\n      filter: { tenantId: { eq: $tenantId }, ssoProviderId: { eq: $ssoProviderId } }\n      atMost: 1\n    ) {\n      affectedCount\n    }\n  }\n": types.DeleteSsoProviderDocument,
    "\n  query TenantSsoPageQuery($tenantId: Int!) {\n    tenantSsoProvidersCollection(\n      filter: { tenantId: { eq: $tenantId } }\n      orderBy: [{ ssoProviderCreatedAt: AscNullsLast }]\n    ) {\n      edges {\n        node {\n          ssoProviderId\n          ssoProviderLabel\n          ssoProviderDomains\n          ssoProviderEnabled\n        }\n      }\n    }\n  }\n": types.TenantSsoPageQueryDocument,
    "\n  mutation CreateTenantFormMutation($tenant_name: String!, $tenant_slug: String!) {\n    tenant: viewerTenantCreate(tenantName: $tenant_name, tenantSlug: $tenant_slug) {\n      tenantId\n    }\n  }\n": types.CreateTenantFormMutationDocument,
    "\n  query CheckEmailQuery($email: String!) {\n    emailDomainHasSso(emailInput: $email)\n    emailExists(emailToCheck: $email)\n    emailHasPassword(emailToCheck: $email)\n  }\n": types.CheckEmailQueryDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  query AgencyOverviewPageQuery($agencyId: Int!) {\n    activeMemberships: viewerAgencyMemberships(\n      agencyId: $agencyId\n      filter: {\n        agencyMembershipAcceptedAt: { is: NOT_NULL }\n        agencyMembershipRevokedAt: { is: NULL }\n        agencyMembershipRejectedAt: { is: NULL }\n      }\n    ) {\n      totalCount\n    }\n    pendingMemberships: viewerAgencyMemberships(\n      agencyId: $agencyId\n      filter: {\n        agencyMembershipAcceptedAt: { is: NULL }\n        agencyMembershipRevokedAt: { is: NULL }\n        agencyMembershipRejectedAt: { is: NULL }\n      }\n    ) {\n      totalCount\n    }\n    grants: permissionGrantsCollection(\n      filter: { subjectAgencyId: { eq: $agencyId } }\n      first: 250\n    ) {\n      edges {\n        node {\n          objectOrganizationId\n          permissionId\n        }\n      }\n    }\n  }\n"): typeof import('./graphql').AgencyOverviewPageQueryDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation ExternalAccessGrantMutation($organization_id: Int!, $agency_id: Int!) {\n    grant: viewerGrantAgencyAccess(organizationId: $organization_id, agencyId: $agency_id) {\n      permissionGrantId\n    }\n  }\n"): typeof import('./graphql').ExternalAccessGrantMutationDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation ExternalAccessRevokeMutation($organization_id: Int!, $agency_id: Int!) {\n    revoke: viewerRevokeAgencyAccess(organizationId: $organization_id, agencyId: $agency_id) {\n      permissionGrantId\n    }\n  }\n"): typeof import('./graphql').ExternalAccessRevokeMutationDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  fragment EditPermissionsFormPermissionFragment on Permissions {\n    permissionId\n    permissionDescription\n  }\n"): typeof import('./graphql').EditPermissionsFormPermissionFragmentFragmentDoc;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  fragment EditPermissionsFormPresetFragment on PermissionPresets {\n    permissionPresetId\n    permissionPresetName\n    permissionPresetSlugs\n    organizationId\n  }\n"): typeof import('./graphql').EditPermissionsFormPresetFragmentFragmentDoc;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  query CheckTenantPermission($tenantId: Int!, $permissionId: String!) {\n    viewerHasTenantPermission(tenantId: $tenantId, permissionId: $permissionId)\n  }\n"): typeof import('./graphql').CheckTenantPermissionDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation InsertSsoProvider($tenantId: Int!, $ssoProviderId: String!, $label: String!, $domains: [String]!, $enabled: Boolean!) {\n    insertIntoTenantSsoProvidersCollection(objects: [{\n      tenantId: $tenantId\n      ssoProviderId: $ssoProviderId\n      ssoProviderLabel: $label\n      ssoProviderDomains: $domains\n      ssoProviderEnabled: $enabled\n    }]) {\n      affectedCount\n    }\n  }\n"): typeof import('./graphql').InsertSsoProviderDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  mutation DeleteSsoProvider($tenantId: Int!, $ssoProviderId: String!) {\n    deleteFromTenantSsoProvidersCollection(\n      filter: { tenantId: { eq: $tenantId }, ssoProviderId: { eq: $ssoProviderId } }\n      atMost: 1\n    ) {\n      affectedCount\n    }\n  }\n"): typeof import('./graphql').DeleteSsoProviderDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  query TenantSsoPageQuery($tenantId: Int!) {\n    tenantSsoProvidersCollection(\n      filter: { tenantId: { eq: $tenantId } }\n      orderBy: [{ ssoProviderCreatedAt: AscNullsLast }]\n    ) {\n      edges {\n        node {\n          ssoProviderId\n          ssoProviderLabel\n          ssoProviderDomains\n          ssoProviderEnabled\n        }\n      }\n    }\n  }\n"): typeof import('./graphql').TenantSsoPageQueryDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "\n  query CheckEmailQuery($email: String!) {\n    emailDomainHasSso(emailInput: $email)\n    emailExists(emailToCheck: $email)\n    emailHasPassword(emailToCheck: $email)\n  }\n"): typeof import('./graphql').CheckEmailQueryDocument;
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
