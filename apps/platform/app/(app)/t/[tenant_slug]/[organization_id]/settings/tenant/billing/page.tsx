...
export default async function TenantBillingPage(
  props: PageProps<"/t/[tenant_slug]/[organization_id]/settings/tenant/billing">,
) {
...
const LOCALE_ES = {
  ...
  subtitle:
    "El plan de esta empresa, los asientos en uso y tu historial de pagos. Lo gestiona quien tenga el permiso de la empresa.",
...
const LOCALE_EN: typeof LOCALE_ES = {
  ...
  title: "Plan & billing",
  subtitle:
    "This company's plan, the seats in use and your payment history. Managed by whoever holds the company permission.",
...
const LOCALE_PT: typeof LOCALE_ES = {
  ...
  subtitle:
    "O plano desta empresa, os assentos em uso e seu histórico de pagamentos. Gerenciado por quem tiver a permissão da empresa.",
