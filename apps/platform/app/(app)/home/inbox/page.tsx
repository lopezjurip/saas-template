...
export default async function InboxPage(props: PageProps<"/home/inbox">) {
  ...
  const openHref = ROUTE("/home/inbox", { locale, filter: "open" });
  const archivedHref = ROUTE("/home/inbox", { locale, filter: "archived" });
        ...
        <div className="divide-border flex-1 divide-y overflow-y-auto">
          {conversations.map((conv) => {
            ...
            return (
              <Link
                key={id}
                href={ROUTE("/home/inbox/[conversation_id]", { locale, conversation_id: id })}
