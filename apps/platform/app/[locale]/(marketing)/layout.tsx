...
const LOCALE_ES = {
  ...
  "footer.tagline": "La plataforma de RR. HH. y nómina para equipos que avanzan.",
...
const LOCALE_EN: typeof LOCALE_ES = {
  ...
  "footer.tagline": "The HR and payroll platform for teams that keep moving.",
...
const LOCALE_PT: typeof LOCALE_ES = {
  ...
  "footer.tagline": "A plataforma de RH e folha de pagamento para times que avançam.",
