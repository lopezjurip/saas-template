...
export async function generateMetadata(props: PageProps<"/[locale]/home/inbox/[conversation_id]">) {
  const { locale, conversation_id } = await props.params;
...
export default async function ConversationPage(props: PageProps<"/[locale]/home/inbox/[conversation_id]">) {
  const { locale, conversation_id } = await props.params;

  const user = await getSupabaseServerUser();
  if (!user) {
    redirect(`/[locale]/auth?next=${encodeURIComponent(`/[locale]/home/inbox/${conversation_id}`)}`);
  }
