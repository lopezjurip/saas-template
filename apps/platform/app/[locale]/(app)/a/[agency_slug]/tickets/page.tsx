...
export async function generateMetadata(props: PageProps<"/[locale]/a/[agency_slug]/tickets">): Promise<Metadata> {
  const { locale } = await props.params;
  const { t } = await getRosetta(LOCALES, locale);
  return { title: t("page_title") };
}

export default async function AgencyTicketsPage(props: PageProps<"/[locale]/a/[agency_slug]/tickets">) {
