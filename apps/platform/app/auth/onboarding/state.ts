...
const METHOD_PATHS = {
  passkey: ROUTE_PATH("/auth/onboarding/passkey"),
  password: ROUTE_PATH("/auth/onboarding/password"),
  phone: ROUTE_PATH("/auth/onboarding/phone"),
  email: ROUTE_PATH("/auth/onboarding/email"),
  document: ROUTE_PATH("/auth/onboarding/document"),
  profile: ROUTE_PATH("/auth/onboarding/profile"),
