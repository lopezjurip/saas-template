---
name: humane-i18n
description: Internationalization patterns for the Humane React/Next.js codebase. Use when adding translations, multi-language support, or when i18n is mentioned.
---

# Internationalization (i18n) — Humane
